		...
		if( (iFrame.length) && (typeof iFrame.attr('srcdoc') !== "undefined") && (iFrame.attr('srcdoc') !== "") ){
			...
			if (error === 1) {
				...
				jQuery.ajax({
					type: "POST",
					url: window.ajaxurl,
					data: {action: 'azexo_submit_form', container_type: window.azexo_form_submit_type, container_name: window.azexo_form_submit_name, name: 'form', values: thisForm.serialize(), },
